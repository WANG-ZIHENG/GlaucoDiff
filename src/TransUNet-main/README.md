...
```bash
CUDA_VISIBLE_DEVICES=0 python train.py --root_path /root/ --dataset 10k --vit_name R50-ViT-B_16
```

- Run the test script on synapse dataset. It supports testing for both 2D images and 3D volumes.

```bash
python test.py --root_path /root/ --dataset sd_gen0 --volume_path  /root/autodl-tmp/gen_image --vit_name R50-ViT-B_16
```
